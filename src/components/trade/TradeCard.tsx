...
export default function TradeCard() {
  return (
    <Link href="/trade/detail/1" className="block">
      <div
        role="status"
        className="max-w-sm p-4 border border-gray-300 rounded-xl shadow-xs animate-pulse md:p-6 cursor-pointer hover:shadow-md transition"
      >
        <div
          role="status"
